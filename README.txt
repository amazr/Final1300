...
BASIC SYNTAX RULES:
	There is no line ending character. To make a distinction between lines, simply hit enter and start typing on the next line!
	Whitespace will be completely ignored EXCEPT inside string literals
	When appending a variable to a string literal wrap the variable name in ':'  EXAMPLE -> display "I have " :numDogs: " dogs" ->I 	have 4 dogs	
...
DECLARING A VARIABLE: 
	...
	The following are the default variable values (if no value is given when created):
		int -> 0
		dec -> 0
		chr -> ''
		str -> ""
...
= (partially), :var: (to append to literal), 
